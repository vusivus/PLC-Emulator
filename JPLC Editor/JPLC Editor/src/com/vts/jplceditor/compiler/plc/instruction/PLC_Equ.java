...
public class PLC_Equ extends Pic18Mem implements PLCInstr {
    ...
    public PLC_Equ(int org, List<PLCOperand> parameters, PLCOperand prevENO) {
    ...
    private void byteToByte(PLCOperand in1, PLCOperand in2) {
        ...
        /*7*/ banksel(STATUS);
        /*8*/ asm.add(new BitInstruction(Opcode.BTFSC, STATUS, Z, bsr));     //if in2=in1 Z=1;
        ...
        /*15*/ asm.add(new ControlInstruction(Opcode.NOP));    //endif address
        wordCount = 16+count;
    }
    ...
    private void byteToInt(PLCOperand in1, PLCOperand in2) {
        ...
        /*6*/ banksel(STATUS);
        /*7*/ asm.add(new BitInstruction(Opcode.BTFSC, STATUS, Z, bsr));    //Check if 0-in2H produces negative                
        ...
        /*14*/ banksel(STATUS);
        /*15*/ asm.add(new BitInstruction(Opcode.BTFSC, STATUS, Z, bsr));    //if zero, equal
    ...
    private void intToByte(PLCOperand in1, PLCOperand in2) {
        ...
        /*5*/ asm.add(new LiteralInstruction(Opcode.SUBLW, 0));
        /*6*/ banksel(STATUS);
        /*7*/ asm.add(new BitInstruction(Opcode.BTFSC, STATUS, Z, bsr));    //Check if 0-in1H produces zero                
        /*8*/ asm.add(new ControlInstruction(Opcode.GOTO, not_equal));
    ...
    private void intToInt(PLCOperand in1, PLCOperand in2) {
        ...
        /*7*/ banksel(STATUS);
        /*8*/ asm.add(new BitInstruction(Opcode.BTFSC, STATUS, Z, bsr));    //Check if in1H-in2H produces zero                
        /*9*/ asm.add(new ControlInstruction(Opcode.GOTO, not_equal));
        ...
        /*15*/ banksel(STATUS);
        /*16*/ asm.add(new BitInstruction(Opcode.BTFSS, STATUS, Z, bsr));    //if zero, equal
